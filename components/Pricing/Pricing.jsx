        ...
        <div className={s.container}>
          ...
          <table className={s.table}>
            ...
            <tr>
              ...
              <td>Доступ ко всем урокам и материалам без выдачи сертификата государственного образца и с выполнением домашних заданий без обратной связи.</td>
              <td><strong>400&nbsp;р</strong></td>
            </tr>
            <tr>
              <td>С сертификатом</td>
              <td>Доступ ко всем урокам и материалам с выдачей сертификата государственного образца и обратной связью по выполненным домашним заданиям.</td>
